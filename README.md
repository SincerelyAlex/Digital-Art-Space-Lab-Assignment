# digital_art_space_app

This project is a lab assignment where we are tasked to create a digital art space
application. The applicatiom should display an array of artwork to the user.
